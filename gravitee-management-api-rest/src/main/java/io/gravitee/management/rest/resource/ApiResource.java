...
public class ApiResource extends AbstractResource {
    ...
    @Permissions({
            @Permission(value = RolePermission.API_DEFINITION, acls = RolePermissionAction.UPDATE),
            @Permission(value = RolePermission.MANAGEMENT_REVIEWS, acls = RolePermissionAction.UPDATE)
    })
    public Response doReviewAction(
        ...
        switch (action.getAction()) {
            case ASK:
                ...
                break;
            case ACCEPT:
                hasPermission(RolePermission.MANAGEMENT_REVIEWS, api, RolePermissionAction.UPDATE);
